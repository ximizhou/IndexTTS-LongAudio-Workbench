...
- The responsive three-tab UI provides 11 official example references, uploaded/saved reference voices, emotion and sampling controls, durable long-text jobs, pause/resume/cancel/retry, segment playback and final WAV/MP3 downloads.
- Server checks pass: `20 passed`, Python compilation and local JavaScript syntax validation.
