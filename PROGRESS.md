...
- Server checks pass: `23 passed`, Python compilation and local JavaScript syntax validation.
...
- Subtitle format v2 removes trailing punctuation from every display cue, suppresses punctuation-only cues without losing their timing, and lazily upgrades completed legacy jobs on download.
